...
function buildSenaryolar() {
  ...
  document.getElementById('senaryo-cards').innerHTML = cardsHtml + '<div style="margin-top:8px;font-size:10px;color:var(--ink3);text-align:center;padding:6px;background:var(--bg);border-radius:6px;display:flex;align-items:center;justify-content:center;gap:4px;"><i data-lucide="info" class="lu" style="width:12px;height:12px;color:var(--ink2);"></i><span>Gösterilen değerler gelecekteki <b>nominal (cari)</b> projeksiyonlardır.</span></div>';
